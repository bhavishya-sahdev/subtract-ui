...
const companyName = "Subtract"
const email = "support@getsubtract.xyz"

export default function PrivacyPolicy() {
    return (
        <div className="bg-white text-black">
            <div className="container p-4 max-w-screen-md space-y-4">
                <h1 className="text-center text-xl">Privacy Policy</h1>
                <p className="text-center text-lg" id="title-company-name">
                    {companyName}
                </p>
                <hr />
                <p>
                    This Privacy Policy describes Our policies and procedures on the collection, use and disclosure of
                    Your information when You respond to our advertisements and tells You about Your privacy rights and
                    how the law protects You. We use Your Personal Data to contact and support you, as well as to
                ...
                <ul>
                    ...
                    <li>
                        <strong>With Affiliates: We </strong>may share Your information with Our affiliates, in which
